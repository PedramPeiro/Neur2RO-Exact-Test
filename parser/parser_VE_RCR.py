...
# ------------ USER INPUT ------------
# Directory containing the VE log files
LOG_DIR = Path(r"D:\uni\PhD Courses\Robust Optimization\Project\Code\Local Results\log_VE_Robust_RCR\2025111720")   # <-- change this
OUTPUT_FILE = r"D:\uni\PhD Courses\Robust Optimization\Project\Code\Local Results\log_VE_Robust_RCR\2025111720\summary_VE_RCR.xlsx"
# ------------------------------------
...
def parse_single_log(text: str, filename: str) -> Dict[str, Any]:
    """Parse one VE log file and return all requested info."""
    ...
    # ---------- x_star from X0, X1, ..., X{n-1} ----------
    # Collect all lines like "X0 = 1", "X3 = 0", ...
    ...
    if x_vals:
        # Determine length: either from n_facilities if available, else from max index
